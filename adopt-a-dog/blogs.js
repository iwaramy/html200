...
for (let i = 0; i < blogPosts.length; i++) {
  let blogImg = document.getElementById('blog-img'+ i);
  blogImg.src = blogPosts[i].imgSrc;
  console.log(blogImg);

  let blogPost = document.getElementById('blog-content'+ i);
  console.log(blogPost);
  blogPost.innerHTML = '<h3>' + blogPosts[i].heading + '</h3><p>' + blogPosts[i].paragraph1
                       + '</p><p>' + blogPosts[i].paragraph2 + "</p>";
}
